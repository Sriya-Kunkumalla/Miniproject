<?php
 ...
 {
  $sql=mysqli_query($con,"insert into contact(name,email,phonenumber,message) values ('$_GET[name]','$_GET[email]','$_GET[mobile]','$_GET[message]')");
  if($sql)
  {
...
<section id="contact">
	...
	<article> They include an email and phone number so that the visitors could quickly find the required information.			
			...
			<form action="" method="GET" class="contactform">
				<p class="input_wrapper"><input type="text" name="name" value=""  id ="contact_nom"><label for="contact_nom">NAME</label></p>
				<p class="input_wrapper"><input type="text" name="email" value=""  id ="contact_email"><label for="contact_email">EMAIL</label></p>
				<p class="input_wrapper"><input type="text" name="mobile" value="" required pattern="[6-9][0-9]{9}" id ="contact_sujet"><label for="contact_sujet">MOBILE</label></p>
				<p class="textarea_wrapper"><textarea name="message" id="contact_message"></textarea></p>
				<p class="submit_wrapper"><input type="submit" value="submit" name="submit"></p>			
			</form>
	</article>
</section>
